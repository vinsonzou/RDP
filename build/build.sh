...
mkdir -p $RDP_PROJ/package/syncer/bin/;scp $RDP_PROJ/3rd_party/$MYSQL_DIR/client/*.sh $RDP_PROJ/package/syncer/bin/ && \
scp $RDP_PROJ/3rd_party/$MYSQL_DIR/bld/client/rdp_syncer $RDP_PROJ/package/syncer/bin/ && \
scp $RDP_PROJ/3rd_party/$MYSQL_DIR/client/*.cfg.example $RDP_PROJ/package/syncer/ && \
mkdir -p $RDP_PROJ/package/syncer/lib && \
mkdir -p $RDP_PROJ/package/syncer/scripts && \
scp $RDP_PROJ/syncer/client/scripts/* $RDP_PROJ/package/syncer/scripts/ && \
scp $RDP_DEPS/glog/lib/libglog.so.0 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/boost/lib/libboost_system.so.1.59.0 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/boost/lib/libboost_thread.so.1.59.0 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/boost/lib/libboost_regex.so.1.59.0 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/jansson/lib/libjansson.so.4 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/librdkafka/lib/librdkafka++.so.1 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/librdkafka/lib/librdkafka.so.1 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/zklib/lib/libzookeeper_mt.so.2 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/protobuf/lib/libprotobuf.so.11 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/librdp_message/lib/librdp_message.so $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/gflags/lib/libgflags.so.2.2 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/rdp-comm/lib/librdp-comm.so  $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/tbb/lib/intel64/gcc4.7/libtbb.so.2 $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/tbb/lib/intel64/gcc4.7/libtbbmalloc.so.2    $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/tbb/lib/intel64/gcc4.7/libtbb_preview.so.2    $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_PROJ/3rd_party/$MYSQL_DIR/bld/libmysql/libmysqlclient.so.* $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_DEPS/lz4/lib/liblz4.so.1    $RDP_PROJ/package/syncer/lib/ && \
scp $RDP_PROJ/tools/user_topic_trans/build/kafka_topic_trans $RDP_PROJ/package/syncer/bin/ && \
scp $RDP_PROJ/tools/fulltopic_check/src/rdp-topic-check $RDP_PROJ/package/syncer/bin/ && \
scp $RDP_PROJ/tools/zk/zk $RDP_PROJ/package/syncer/bin/ && \
scp $RDP_PROJ/tools/save_file_into_mysql/save_file_into_mysql $RDP_PROJ/package/syncer/scripts/ && \
scp $RDP_PROJ/3rd_party/$MYSQL_DIR/bld/client/mysqldump $RDP_PROJ/package/syncer/scripts/ && \
